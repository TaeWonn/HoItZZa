	...
	<section>
		<div id="faq-container">
			...
			<colgroup>
				...
				<tr id="p-tag">
					<td>1<p><br/><br/></p></td>
					<td>서비스/피해/오류문의<p><br/><br/></p></td>
					<td>계정문의<p><br/><br/></p></td>
				...
				<tr id="p-tag">
					<td>4<p><br/><br /><br /></p></td>
					<td>서비스/피해/오류문의<p><br /><br /><br/></p></td>
					<td>피해문의<p><br/><br /><br /></p></td>
...
$("tr:first").nextAll().click(function() {
	...
	$(this).children("td:last").each(function() {
		$(this).children("p").slideToggle(200).css("color","black");
	});
});
</script>
