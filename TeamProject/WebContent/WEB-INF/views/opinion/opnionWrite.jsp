...
<article id="article">
	...
	<div id="freeBoard">
	<form action="<%=request.getContextPath()%>/opinon/opinonWriteEnd"
	 method="post" enctype="multipart/form-data" >
			<h3 style="text-align: center; margin:0 auto; padding: 20px 0 0 0;">신고/건의  작성</h3>
				<br>
	        ...
	        <select class="custom-select" id="boardCodeNo" name="boardCodeNo">
	                ...
	                <option value="OT_">건의 게시판</option>
	        </select>
	        <br>
