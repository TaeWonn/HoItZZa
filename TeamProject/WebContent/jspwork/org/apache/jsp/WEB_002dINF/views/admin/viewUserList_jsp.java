 ...
 * Generated at: 2019-06-09 02:32:41 UTC
...
if(searchType!=null){
      ...
      out.write("\t\t\t<th>아이디</th>\r\n");
      out.write("\t\t\t<th>이름</th>\r\n");
      out.write("\t\t\t<th><nobr>경고 횟수</nobr></th>\r\n");
      out.write("\t\t\t<th>경고처리</th>\r\n");
      out.write("\t\t\t<th>이메일</th>\r\n");
      out.write("\t\t\t<th>연락처</th>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t</thead>\r\n");
 ...
 for(int i=0;i<userList.size();i++){if(!userList.get(i).getUserId().equals("admin")){ 
      ...
      out.write("/views/user/userInfo?userId=");
      out.print(userList.get(i).getUserId());
      out.write("'\"><nobr><label for=\"\">");
      out.print(warningCount.get(userList.get(i).getUserId()) );
      out.write("회</label></nobr></td>\r\n");
      out.write("\t\t\t<td><nobr> <input type=\"button\" style=\"width:90px;\" id=\"warningBtn\"value=\"경고처리\" onclick=\"warningUser('");
      out.print(userList.get(i).getUserId() );
      out.write("');\" /></nobr></td>\r\n");
      out.write("\t\t\t<td id=\"userId\"><nobr>  ");
      ...
      out.write("}\r\n");
      out.write("function warningUser(userId){\r\n");
      out.write("\tvar bool=prompt(userId+\"유저에게 경고 1회를 주시겠습니까?\\n경고 코드를 입력해주십시오.\\n D_A : 욕설 / D_S : 사기 / D_M : 비매너 / D_P : 음란물 관련 게시 / D_R : 허위신고\\n게시글번호 입력(필수) 시 경고 코드 뒤에 콤마(,)를 입력해주세요.\");\r\n");
      ...
      out.write("\t\tlocation.href=\"");
      out.print(request.getContextPath());
      out.write("/admin/warningUser?userId=\"+userId+\"&reason=\"+bool;\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("}\r\n");
      out.write("</script>\r\n");
