 ...
 * Generated at: 2019-06-11 03:50:30 UTC
...
List<FileTable> file = (List<FileTable>)request.getAttribute("fileList");
      ...
      out.write("\r\n");
      out.write("    <h2 style=\"text-align: center;\">구매 게시판</h2>\r\n");
      ...
      out.write("</span>\r\n");
      out.write("        <span class=\"ed text-xsmall text-muted\">");
      out.print(b.getBoardDate() );
      out.write("</span>\r\n");
      out.write("        <span class=\"ed text-xsmall text-muted\">조회수 ");
...
if(file!=null){for(int i=0;i<file.size();i++){ 
      ...
      out.write("\t\t");
      out.print(file.get(i).getOriginalFileName() );
      out.write("\r\n");
      out.write("\t\t");
}}else{ 
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("            <div style=\"width: 100%; margin-left: -16px; min-height: 360px;\">\r\n");
      out.write("                ");
      ...
      out.print(next.getBoardTitle()!=null?next.getBoardTitle():"다음글 없습니다");
      out.write(" ]</a></td>  \r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td><a onclick=\"prev_btn();\" id=\"prev_btn\"> [이전글 : ");
      out.print(prev.getBoardTitle()!=null?prev.getBoardTitle():"이전글 없습니다");
      out.write(" ]</a></td>  \r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t</div>\r\n");
...
if(userLoggedIn != null){ 
      ...
      out.print(request.getContextPath());
      out.write("/buy/buyModified?boardNo=");
      out.print(b.getBoardNo());
      out.write("'\" />\r\n");
      ...
      out.write("\t\t\t\tonclick=\"location.href='");
      out.print(request.getContextPath());
      out.write("/buy/buyList'\">목록</button>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<Br>\r\n");
      out.write("      \r\n");
...
if(userLoggedIn!=null 
      ...
      out.write("\t\t\t\t\t\t<td id=\"CommentContentsReply\"><sub class=\"comment-writer\">");
      out.print(bc.getCommentWriter());
      out.write("</sub>\r\n");
      out.write("\t\t\t\t\t\t\t<sub class=\"comment-date\">");
      out.print(bc.getCommentDate() );
...
if(userLoggedIn!=null && ("admin".equals(userLoggedIn.getUserId()) 
      ...
      out.write("\tlocation.href=\"");
      out.print(request.getContextPath());
      out.write("/buy/buyDelete?boardNo=");
      out.print(b.getBoardNo());
      out.write("\";\r\n");
      out.write("}\r\n");
      out.write("function loginAlert(){\r\n");
 ...
 if(userLoggedIn == null){ 
      ...
      out.print(request.getContextPath());
      out.write("/buy/buyComment\" method=\"post\">';\r\n");
      ...
      out.write("\t\t location.href=\"");
      out.print(request.getContextPath());
      out.write("/buy/buyCommentDelete?commentNo=\"+$(this).val()+\"&boardNo=");
      out.print(b.getBoardNo());
      out.write("\";\r\n");
      out.write("\t});\r\n");
      out.write("});\r\n");
