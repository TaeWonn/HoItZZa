 ...
 * Generated at: 2019-06-10 12:42:04 UTC
...
public final class freeForm_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if (userLoggedIn == null) { 
      ...
      out.write("\t<form action=\"");
      out.print(request.getContextPath());
      out.write("/free/freFormEnd\"\r\n");
      out.write("\t method=\"post\" enctype=\"multipart/form-data\" >\r\n");
      out.write("\t\t<div id=\"freeBoard\">\r\n");
      out.write("\t\t\t<h3 style=\"text-align: center;margin:0 auto;\">자유게시판  작성</h3>\r\n");
      out.write("\t\t\t\t<br>\r\n");
      out.write("\t        \t<input type=\"text\" class=\"alert alert-light\" role=\"alert\" name=\"boardTitle\" id=\"boardTitle\" style=\"margin-left: 4.4%;\" placeholder=\"제목을 입력해주세요\">\r\n");
      out.write("\t        \t<br>\r\n");
      out.write("\t       \t <input type=\"text\" class=\"alert alert-light\" role=\"alert\" name=\"boardWriter\" id=\"userId\" style=\"margin-left: 4.4%;\" value=\"");
      out.print(userLoggedIn.getUserId() );
      out.write("\" readonly > \r\n");
      out.write("\t        <br>\r\n");
      out.write("\t\r\n");
      out.write("\t        <select class=\"custom-select\" id=\"boardCodeNo\" name=\"boardCodeNo\" style=\"margin-left: 4.4%;\">\r\n");
      out.write("\t                <option selected>게시판 선택</option>\r\n");
      out.write("\t                <option value=\"FC_\">잡담 게시판</option>\r\n");
      out.write("\t                <option value=\"FU_\">유용한 생활지식 게시판</option>\r\n");
      out.write("\t                <option value=\"FE_\">연예/미디어 게시판</option>\r\n");
      out.write("\t                <option value=\"FS_\">나눔게시판</option>\r\n");
      out.write("\t        </select>\r\n");
      out.write("\t        <br>\r\n");
      ...
      out.write("\t        \r\n");
      out.write("\t        \r\n");
      out.write("\t        <div id=\"img-viewer\" style=\"display: block;\"></div>\r\n");
      out.write("\r\n");
      out.write("\t        \r\n");
      out.write("\t        </div><br>\r\n");
      out.write("        \r\n");
      out.write("        <div class=\"filebox\">\t\t\t\r\n");
      out.write("\t\t\t<input type=\"file\"  id=\"ex_img\" onchange=\"loadImg(this);\" name=\"imgFile\">\t\t\t \r\n");
      out.write("\t\t   <label for=\"ex_img\">이미지삽입</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t    <input type=\"file\"  id=\"ex_filename\" class=\"upload-hidden\"name=\"upFile\" > \r\n");
      out.write("\t\t    \r\n");
      out.write("\t\t  <input class=\"upload-name\" value=\"파일명\" disabled=\"disabled\" >\r\n");
      out.write("\t\t  \r\n");
      out.write("\t\t  <label for=\"ex_filename\">파일 업로드</label>\r\n");
      out.write("\t\t <!--  <input type=\"file\"  id=\"ex_filename2\" class=\"upload-hidden\"  > -->\r\n");
      out.write("\t\t  <input type=\"hidden\" name=\"boardContent\" id=\"cont\" />\r\n");
      out.write("\t\t</div>\r\n");
      out.write("          \r\n");
      ...
      out.write("                </div>\r\n");
      out.write("            </form>\r\n");
      out.write("       </div> <!-- div#frrBoard End -->\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("<script>\r\n");
      out.write("\r\n");
      ...
      out.write("\t//내용\r\n");
      out.write("\tvar boardContent = document.getElementById('boardContent').textContent.trim();\r\n");
      out.write("\tconsole.log('컨텐츠'+boardContent);\r\n");
      out.write("\tif(boardContent.length == 0){\r\n");
      out.write("\t\talert(\"내용을 입력하세요.\");\r\n");
      out.write("\t\treturn false;\r\n");
      out.write("\t}else{\r\n");
      out.write("\t\t$('#cont').val(boardContent);\r\n");
      out.write("\t}\r\n");
      out.write("\tconsole.log('밸류'+$('#cont').val());\r\n");
      out.write("\t//제목\r\n");
      ...
      out.write("\tconsole.log($('#ex_img').val());\r\n");
      out.write("\tconsole.log($('#ex_filename').val());\r\n");
      out.write("\tvar files=Array.prototype.slice.call(f.files);\r\n");
      out.write("\t\r\n");
      out.write("\tfiles.forEach(function(f){\r\n");
      out.write("\t\tsel_file.push(f);\r\n");
      out.write("\t\tvar reader = new FileReader();\r\n");
      out.write("\t\treader.onload = function(e){\r\n");
      out.write("\t\t\t//result속성에는 파일컨텐츠 담겨있음.\r\n");
      out.write("\t\t \t$(\"#img-viewer\").append('<img src=\"'+reader.result+'\" alt=\"\" />').css('width','300px')\r\n");
      out.write("\t\t\t\t\t\t\t.css('max-height','300px')\r\n");
      out.write("\t\t\t\t\t\t\t.css('max-width','500px')\r\n");
      out.write("\t\t\t\t\t\t\t.css('height','300px')\r\n");
      out.write("\t\t\t\t\t\t\t.css('position','relative')\r\n");
      out.write("\t\t\t\t\t\t\t.css('left','10px')\r\n");
      out.write("\t\t\t\t\t\t\t.css('top','6px');\r\n");
      out.write("\t\t}\r\n");
      ...
      out.write("\tfor(var i=0;i<f.files.length;i++){\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\tvar reader = new FileReader();\r\n");
      out.write("\t\t//파일읽기메소드 호출. 읽기완료하면 onload에 등록된 함수를 호출\r\n");
      out.write("\t\tconsole.log(f.files[i]);\r\n");
      out.write("\t\tconsole.log('파일객체');\r\n");
      out.write("\t\treader.readAsDataURL(f.files[i]);\r\n");
      out.write("\t\treader.onload = function(){\r\n");
      out.write("\t\t\tconsole.log(reader);\r\n");
      out.write("\t\t\t//result속성에는 파일컨텐츠 담겨있음.\r\n");
      out.write("\t\t\t/* $(\"#img-viewer\").append(attr(\"src\", reader.result).css('width','300px') */\r\n");
      out.write("\t\t/* \t$(\"#img-viewer\").append('<img src=\"'+reader.result+'\" alt=\"\" />').css('width','300px')\r\n");
      out.write("\t\t\t\t\t\t\t.css('max-height','300px')\r\n");
      out.write("\t\t\t\t\t\t\t.css('max-width','500px')\r\n");
      out.write("\t\t\t\t\t\t\t.css('height','300px')\r\n");
      ...
      out.write("\tvar files=document.getElementById('ex_filename');\r\n");
      out.write("\tvar maxPostSize = 1024 * 1024 * 30;\r\n");
      out.write("\tfor(var i=0;i<files.files.length;i++){\r\n");
      out.write("\t\tvar fileSize=document.getElementById('ex_filename').files[0].size;\r\n");
      out.write("\t\tif(fileSize>maxPostSize){\r\n");
      out.write("\t\t\talert('파일 크기는 '+(maxPostSize/1024/1024)+\"MB를 넘길 수 없습니다.\");\r\n");
      out.write("\t\t\tfileTarget.val('');\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
