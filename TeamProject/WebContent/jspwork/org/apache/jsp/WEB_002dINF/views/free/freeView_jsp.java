 ...
 * Generated at: 2019-06-11 00:02:51 UTC
...
public final class freeView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("file.model.vo.FileTable");
 ...
 if (userLoggedIn == null) { 
	...
	Free after=(Free)request.getAttribute("after");
      ...
      out.write("<style>\r\n");
      out.write("\r\n");
      out.write("#boardContent div{\r\n");
      out.write("\ttext-align: left;\t\r\n");
      out.write("}\r\n");
      out.write("div#min_div{\r\n");
      out.write("\ttext-align: left;\r\n");
...
if(userLoggedIn != null){ 
      ...
      out.write("\t\tstyle=\"width: 590px; border: 0.2px solid lightgrayv; margin: auto;\">\r\n");
      out.write("\t\t<div style=\"width: 100%; border: 1px solid; margin-top: 28px; margin-left: -16px;\" >\r\n");
      out.write("\t\t");
if(file!=null){for(int i=0;i<file.size();i++){ 
      ...
      out.print(f.getBoardNo().substring(0,3)+(Integer.parseInt(f.getBoardNo().substring(3))-1));
      out.write('"');
      out.write('>');
      out.print(prev.getBoardTitle()==null?"":prev.getBoardTitle() );
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</a></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      ...
      out.write('"');
      out.write('>');
      out.print(after.getBoardTitle()==null?"":after.getBoardTitle() );
      out.write("</a></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t</div>\r\n");
 ...
 if(userLoggedIn!=null&&( userLoggedIn.getUserId().equals(f.getBoardWriter())||userLoggedIn.getUserId().equals("admin"))){ 
      out.write("\r\n");
      out.write("\t\t<input type=\"button\" onclick=\"updateFreeBoard('");
      out.print(f.getBoardNo());
      out.write("');\" value=\"수정\">\r\n");
      out.write("\t\t<input type=\"button\" onclick=\"checkDelete();\" value=\"삭제\">\r\n");
      out.write("\t");
 } 
      out.write("\r\n");
