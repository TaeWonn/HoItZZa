 ...
 * Generated at: 2019-06-05 03:23:12 UTC
...
public final class message_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("message.model.vo.Message");
...
if(searchType!=null){
      ...
      out.write("<link rel=\"stylesheet\" href=\"");
      out.print(request.getContextPath());
      out.write("/css/message/message.css\" />\r\n");
      out.write("\r\n");
      out.write("<article>\r\n");
      out.write("\t<h2 id=\"title2\" >쪽지함</h2>\r\n");
      out.write("\t<form action=\"");
      out.print(request.getContextPath());
      out.write("/views/message/myMessage2\" method=\"post\" id=\"sub\" >\r\n");
      out.write("\t\t<div id=\"senRec\">\r\n");
      out.write("\t\t<select name=\"senRec\"  onchange=\"submit();\">\r\n");
      out.write("\t\t\t\t<option value=\"receive\"\r\n");
      out.write("\t\t\t\t\t");
      out.print("receive".equals(senRec) ? "selected" : "");
      out.write(">받은 쪽지함</option>\r\n");
      out.write("\t\t\t\t<option value=\"send\"\r\n");
      out.write("\t\t\t\t\t");
      out.print("send".equals(senRec) ? "selected" : "");
      ...
      out.write("\t\t\t<tr id=\"tHeader\">\r\n");
      out.write("\t\t\t\t<th scope=\"col\" style=\"max-width:80px;\">");
      out.print(senRec==null||senRec.equals("receive")?"발신인":"수신인" );
      out.write("</th>\r\n");
      out.write("\t\t\t\t<th scope=\"col\">내용</th>\r\n");
      out.write("\t\t\t\t<th scope=\"col\" style=\"max-width: 90px;\">작성일자</th>\r\n");
...
if(senRec==null||senRec.equals("receive")){for(int i=0;i<list.size();i++){ 
      out.write("\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th scope=\"row\"><nobr>");
      out.print(list.get(i).getSender() );
      out.write("</nobr></th>\r\n");
      out.write("\t\t\t\t<td><nobr>");
      out.print( list.get(i).getContent());
      out.write("</nobr></td>\r\n");
      out.write("\t\t\t\t<td><nobr>");
      out.print(list.get(i).getNoteDate() );
      out.write("</nobr></td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<button type=\"button\" class=\"btn btn-secondary\"  onclick=\"reply('");
      out.print(userLoggedIn.getUserId() );
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(list.get(i).getSender());
      out.write("');\">답장</button>\r\n");
      out.write("\t\t\t\t\t<button type=\"button\" class=\"btn btn-secondary\"  onclick=\"deletemsg('");
      out.print(list.get(i).getMessageNo());
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(list.get(i).getRecipient());
      out.write("');\">삭제</button>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t");
      ...
      out.write("\t\t");
      out.print(pageBar!=null?pageBar:"" );
      out.write("\r\n");
      out.write("\t</div>\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\t\t");
      out.print("userId".equals(searchType) ? "selected" : "" );
      out.write(">아이디로\r\n");
      out.write("\t\t\t\t조회</option>\r\n");
      ...
      out.write("' /> \r\n");
      out.write("\t\t\t\t<input type=\"button\" value=\"검색\" onclick=\"submit2();\"/>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div id=\"search-content\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t<input type=\"search\" onchange=\"insertKeyword(this);\" \r\n");
      out.write("\t\t\t\tvalue='");
      out.print("content".equals(searchType)?searchKeyword:"" );
      out.write("'\r\n");
      out.write("\t\t\t\tsize=\"25\" placeholder=\"검색할 내용을 입력하세요\" />\r\n");
      out.write("\t\t\t<input type=\"button\" value=\"검색\" onclick=\"submit2();\"/>\r\n");
      out.write("\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t<form action=\"");
      out.print(request.getContextPath());
      out.write("/views/message/messageFinder\" id=\"submit2\" method=\"post\">\r\n");
      out.write("\t\t\t<input type=\"hidden\" name=\"searchType\" />\r\n");
      out.write("\t\t\t<input type=\"hidden\" name=\"searchKeyword\" />\r\n");
      out.write("\t\t\t<input type=\"hidden\" name=\"userId\" value=\"");
      out.print(userLoggedIn.getUserId());
      out.write("\"/>\r\n");
      out.write("\t\t\t<input type=\"hidden\" name=\"senRec\" value=\"");
      out.print(senRec!=null?senRec:"receive" );
      out.write("\" />\r\n");
      out.write("\t\t</form>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("function deletemsg(msgNo,userId){\r\n");
      out.write("\t//사용자가 recipient, 보낸사람이 sender\r\n");
      out.write("\tvar bool=confirm('정말 삭제하시겠습니까?');\r\n");
      out.write("\tif(bool){\r\n");
      out.write("\tlocation.href=\"");
      out.print(request.getContextPath());
      out.write("/views/message/messageDelete?msgNo=\"+msgNo+\"&userId=\"+userId;\t\t\r\n");
      out.write("\t}\r\n");
      out.write("}\r\n");
