 ...
 * Generated at: 2019-06-09 01:40:57 UTC
...
if(senRec==null||senRec.equals("receive")){for(int i=0;i<list.size();i++){ 
      out.write("\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th scope=\"row\" onclick=\"msgView('");
      out.print(list.get(i).getMessageNo());
      out.write("');\"><nobr>");
      out.print(list.get(i).getSender() );
      out.write("</nobr></th>\r\n");
      out.write("\t\t\t\t<td onclick=\"msgView('");
      out.print(list.get(i).getMessageNo());
      out.write("');\"><nobr>");
      ...
      out.write("\r\n");
      out.write("//쪽지 내용 보기\r\n");
      out.write("function msgView(msgNo){\r\n");
      out.write("\tvar url=\"");
      out.print(request.getContextPath());
      out.write("/views/user/msgView?msgNo=\"+msgNo;\r\n");
      out.write("\tvar title=\"쪽지 보기\";\r\n");
      out.write("\tvar specs=\"width=400px, height=450px, left=500px, top=200px\";\r\n");
      out.write("\tvar popup=open(url, title,specs);\r\n");
      out.write("}\r\n");
      out.write("\r\n");
