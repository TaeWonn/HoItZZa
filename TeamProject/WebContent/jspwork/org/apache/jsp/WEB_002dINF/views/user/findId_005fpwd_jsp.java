 ...
 * Generated at: 2019-06-10 03:35:39 UTC
...
public final class findId_005fpwd_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if (userLoggedIn == null) { 
      ...
      out.write("<link rel=\"stylesheet\" href=\"");
      out.print(request.getContextPath());
      out.write("/css/user/findId_pwd.css\" />\r\n");
      out.write("<article id=\"article\">\r\n");
      out.write("\t<div id=\"findUserService\">\r\n");
      out.write("\t\t<h1>회원 정보 찾기</h1>\r\n");
      out.write("\t\t<br />\r\n");
      out.write("\t\t<div id=\"findId\">\r\n");
      out.write("\t\t<form action=\"");
      out.print(request.getContextPath() );
      out.write("/views/user/findId\" method=\"post\" onsubmit=\"checkFindId();\">\r\n");
      out.write("\t\t\t<h3 class=\"formTitle\">아이디 찾기</h3>\r\n");
      out.write("\t\t\t<table>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th>이름</th>\r\n");
      out.write("\t\t\t\t<td><input type=\"text\" name=\"findUserId_name\" required=\"required\" /></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th>전화번호</th>\r\n");
      out.write("\t\t\t\t<td><input type=\"number\" name=\"findUserId_phone\"  placeholder=\"하이픈(-)없이 입력\" required /></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t<th></th>\r\n");
      out.write("\t\t\t<td><button type=\"submit\" class=\"btn btn-info\">아이디 찾기</button></td></tr>\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t</form>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t<form action=\"");
      out.print(request.getContextPath() );
      out.write("/views/user/findPwd\" method=\"post\" onsubmit=\"return checkPwdInfo();\" >\r\n");
      out.write("\t\t\t<h3 class=\"formTitle\">비밀번호 찾기</h3>\r\n");
      out.write("\t\t\t<table>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<th>아이디</th>\r\n");
      out.write("\t\t\t\t\t<td><input type=\"text\" name=\"findUserPwd_Id\"  /></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<th>이름</th>\r\n");
      out.write("\t\t\t\t\t<td><input type=\"text\" name=\"findUserPwd_name\"  /></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<th>주민등록번호</th>\r\n");
      out.write("\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" class=\"ssn\" name=\"findUserPwd_ssn_1\" id=\"ssn_1\" maxlength='6'/>&nbsp;ㅡ&nbsp;\r\n");
      out.write("\t\t\t\t\t\t<input type=\"password\" class=\"ssn\" name=\"findUserPwd_ssn_2\" id=\"ssn_2\" maxlength='7' />\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<th></th>\r\n");
      out.write("\t\t\t\t\t<td><button type=\"submit\" class=\"btn btn-info\">비밀번호 찾기</button></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t</form>\r\n");
      ...
      out.write("</article>\r\n");
      out.write("<script>\r\n");
      out.write("function checkFindId(){\r\n");
      out.write("\tvar name=$('input[name=findUserId_name]').val().trim();\r\n");
      out.write("\tvar phone=$('input[name=findUserId_phone]').val().trim();\r\n");
      ...
      out.write("\t\t\treturn;\t\r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\tvar checkcontains=phone.indexOf('-');\r\n");
      out.write("\t\t\tif(checkcontains!=-1){\r\n");
      out.write("\t\t\t\talert('하이픈을 제외하고 입력해주세요');\r\n");
      out.write("\t\t\t\treturn;\t\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function checkPwdInfo(){\r\n");
      out.write("\tvar $id=$('input[name=findUserPwd_Id]').val().trim();\r\n");
      out.write("\tvar $name=$('input[name=findUserPwd_name]').val().trim();\r\n");
      out.write("\tvar ssn1=$('#ssn_1').val().trim();\r\n");
      out.write("\tvar ssn2=$('#ssn_2').val().trim();\r\n");
      out.write("\t//주민등록번호 유효성 검사\r\n");
      out.write("\tvar reg1=/^[0-9]{6}$/;\r\n");
      out.write("\tvar regSsn1=reg1.test(ssn1);\r\n");
      out.write("\tvar reg2=/^[0-9]{7}$/;\r\n");
      out.write("\tvar regSsn2=reg2.test(ssn2);\r\n");
      out.write("\t\r\n");
      out.write("\tif($id.length==0){\r\n");
      ...
      out.write("\t\treturn false;\r\n");
      out.write("\t}else if(ssn1.length==0||ssn2.length==0){\r\n");
      out.write("\t\talert('주민등록번호가 입력되지 않았습니다.');\r\n");
      out.write("\t\treturn false;\r\n");
      out.write("\t}else if(!regSsn1 || !regSsn2){\r\n");
      out.write("\t\talert('올바른 주민등록 번호를 입력해주세요.');\r\n");
      out.write("\t\treturn false;\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
