 ...
 * Generated at: 2019-06-10 08:40:29 UTC
...
public final class userInfo_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if (userLoggedIn == null) { 
	...
	String[] addrArr = u.getAddr().split(",");
      ...
      out.write("\r\n");
      out.write("<style>\r\n");
      out.write("table#interestSellBoard2{position:absolute;width:308px;padding:0px;border:1px solid; border-collapse: collapse;\r\n");
      out.write("\t\t\t\ttop:40px; table-layout:fixed;}\r\n");
      out.write("table#interestSellBoard2 th{max-width:76px;border:1px solid;text-align: center;background: lightgray;text-overflow:ellipsis;}\r\n");
      out.write("table#interestSellBoard2 td{max-width:120px;border:1px solid;text-align: center;max-height: 10px;text-overflow:ellipsis;}\r\n");
      out.write("table#interestSellBoard2 th,td{overflow:hidden;}\r\n");
      out.write("table#interestSellBoard2 tr{max-height: 10px; overflow: hidden;}\r\n");
      out.write("</style>\r\n");
      out.write("\r\n");
      out.write("<script src=\"http://dmaps.daum.net/map_js_init/postcode.v2.js\"></script>\r\n");
      out.write("<link rel=\"stylesheet\" href=\"");
      out.print(request.getContextPath());
      out.write("/css/user/userInfo.css\" />\r\n");
      out.write("\r\n");
      out.write("<article>\r\n");
      out.write("\r\n");
      out.write("<div id=\"viewMain\">\r\n");
      out.write("\t<span id=\"h1\">");
      out.print(u.getUserId());
      out.write("님의 개인 페이지</span>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<div id=\"infoList\">\r\n");
      out.write("<form action=\"");
      out.print(request.getContextPath() );
      out.write("/views/user/updateInfo\" method=\"post\">\r\n");
      out.write("\t<table id=\"userInfoTable\">\r\n");
      out.write("\t\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<th>이름</th>\r\n");
      out.write("\t\t\t<td><input type=\"text\" value=\"");
      out.print(u.getName() );
      out.write("\" name=\"userName\" readonly /></td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<th>포인트</th>\r\n");
      out.write("\t\t\t<td><input type=\"text\" value=\"");
      out.print(u.getPoint());
      ...
      out.write("\t\t\t<td><input type=\"button\" value=\"변경하기\" class=\"btn\" onclick=\"return changeUserPwd('");
      out.print(u.getUserId());
      out.write('\'');
      out.write(',');
      out.write('\'');
      ...
      out.print(addrArr[0] );
      out.write("\"  name=\"addr1\" readonly/>\r\n");
      out.write("\t\t\t\t<input type=\"text\" value=\"");
      out.print(addrArr[1] );
      out.write("\"  name=\"addr2\" placeholder=\"상세주소\"/>\r\n");
      out.write("\t\t\t\t<input type=\"button\" value=\"주소찾기\" class=\"btn\" onclick=\"searchAddr();\"/>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
...
for(int i=0;i<interestArr.length;i++){
      ...
      out.print(i+1);
      out.write("\" class=\"interestBo\" >\r\n");
      out.write("\t\t\t<option value=\"\" selected>");
      out.print(interestArr[i] );
      out.write("</option>\r\n");
      ...
      out.write("\t\t\t<th></th>\r\n");
      out.write("\t\t\t<td >\r\n");
      out.write("\t\t\t<input type=\"submit\" value=\"정보 수정\" class=\"btnGroup\"/> \r\n");
      out.write("\t\t\t<input type=\"button\" value=\"탈퇴\" class=\"btnGroup\" onclick=\"deleteUser('");
      out.print(u.getUserId());
      out.write(',');
      out.print(u.getSsn());
      out.write(',');
...
if(userLoggedIn.getUserId().equals("admin")){ 
      out.write("\r\n");
      out.write("\t\t\t<input type=\"button\" value=\"블랙리스트 \" class=\"btnGroup\" onclick=\"blackUser('");
      out.print(u.getUserId());
      out.write('\'');
      out.write(',');
      out.write('\'');
      ...
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<div id=\"interestBoard\">\r\n");
      out.write("\t<h3>관심글</h3>\t\r\n");
      out.write(" \t ");
  if(interest1BoardList!=null){ 
      out.write("\r\n");
      out.write("\t<table id=\"interestSellBoard\">\r\n");
      out.write("\t<tr>\r\n");
      out.write("\t\t<th><nobr>번호</nobr></th>\r\n");
      out.write("\t\t<th><nobr>제목</nobr></th>\r\n");
      out.write("\t\t<th><nobr>작성자</nobr></th>\r\n");
      out.write("\t\t<th><nobr>조회수</nobr></th>\r\n");
      out.write("\t</tr>\r\n");
      out.write("\t\t");
 for(int i=1;i<=interestBBoardList.size();i++){
      ...
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<td><nobr> ");
      out.print(interestBBoardList.get(i).getBoardNo() );
      out.write(" </nobr></td>\r\n");
      out.write("\t\t\t<td><nobr> ");
      out.print(interestBBoardList.get(i).getBoardTitle() );
      out.write(" </nobr></td>\r\n");
      out.write("\t\t\t<td><nobr>");
      out.print(interestBBoardList.get(i).getBoardWriter() );
      out.write(" </nobr></td>\r\n");
      out.write("\t\t\t<td><nobr> ");
      out.print(interestBBoardList.get(i).getBoardReadCounter());
      out.write(" </nobr></td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t");
  } }else{ 
      out.write("\r\n");
      out.write("\t<table id=\"interestSellBoard2\">\r\n");
      out.write("\t<colgroup>\r\n");
      out.write("\t    <col width=\"55px\">\r\n");
      out.write("        <col width=\"55px\">  <!-- 너비를 지정해주어야한다 -->\r\n");
      out.write("        <col width=\"55px\">  <!-- 너비를 지정해주어야한다 -->\r\n");
      out.write("        <col width=\"55px\">\r\n");
      out.write("\t</colgroup>\r\n");
      out.write("\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td colspan=\"4\">관심글이 존재하지 않습니다.</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\r\n");
      out.write("\t");
} 
      out.write(" \r\n");
      out.write("\t</table>\r\n");
      out.write("\t<div id=\"pageBar\" style=\"top:460px;\">\r\n");
      out.write("\t\t");
      out.print(pageBar );
      out.write("\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<div id=\"interestBoardAll\">\r\n");
      out.write("\t<p>관심사 추천 글</p>\r\n");
      out.write("\t\t<table id=\"recommendBoard\">\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t<!-- 판매게시판 글만 가져오므로 링크걸때 판매게시판쪽 DB만 보도록 해야함. 주의할것. -->\r\n");
      out.write("\t\t\t<th><nobr>");
      out.print(interestArr[0] );
      out.write("</nobr></th>\r\n");
      out.write("\t\t\t");
 for(int i=0;i<5;i++){
      out.write("\r\n");
      ...
      out.write("/\"><img src=\"");
      out.print(request.getContextPath() );
      out.write("/images/leo.jpg\" alt=\"\" /><br />\r\n");
      out.write("\t\t\t<span><nobr>");
      out.print(i+1 );
      out.write("번제품 팝니다!!!!!!!!!!!!!!!!1</nobr></span></a></td>\r\n");
      out.write("\t\t\t");
} 
      out.write("\r\n");
      out.write("\t\t</tr>\r\n");
 ...
 for(int i=0;i<5;i++){
      ...
      out.write("/\"><img src=\"");
      out.print(request.getContextPath() );
      out.write("/images/냥챗 아이콘.jpg\" alt=\"\" /><br />\r\n");
      out.write("\t\t\t<span><nobr>");
      out.print(i+1 );
      out.write("번제품 팝니다!!!!!!!!!!!!!!!!1</nobr></span></a></td>\r\n");
      out.write("\t\t\t");
 ...
 for(int i=0;i<5;i++){
      ...
      out.write("/\"><img src=\"");
      out.print(request.getContextPath() );
      out.write("/images/강사님.PNG\" alt=\"\" /><br />\r\n");
      out.write("\t\t\t<span><nobr>");
      out.print(i+1 );
      out.write("번제품 팝니다!!!!!!!!!!!!!!!!1</nobr></span></a></td>\r\n");
      out.write("\t\t\t");
      ...
      out.write("\t\t      $('input[name=addr1]').val(address1);\r\n");
      out.write("\t\t      //지번주소 표기는 폐기처리.$('#address2').val('(지번주소)'+jibun+' ');\r\n");
      out.write("\t\t  }\r\n");
      out.write("\t\t}).open();\r\n");
      out.write("}\r\n");
      out.write("//비밀번호 변경페이지로 이동\r\n");
      out.write("function changeUserPwd(userId,name,ssn){\r\n");
      out.write("\tconsole.log(userId);\r\n");
      out.write("\tconsole.log(typeof ssn);\r\n");
      out.write("\tvar ssn1=ssn.substring(0,6);\r\n");
      out.write("\tconsole.log(ssn1);\r\n");
      out.write("\tvar ssn2=ssn.substring(6);\r\n");
      out.write("\tconsole.log(ssn2);\r\n");
      out.write("\tlocation.href=\"");
      out.print(request.getContextPath());
      out.write("/views/user/updatePwd?findUserPwd_Id=\"+userId+\"&findUserPwd_name=\"+name+\"&findUserPwd_ssn_1=\"+ssn1+\"&findUserPwd_ssn_2=\"+ssn2;\r\n");
      ...
      out.write("\tlocation.href=\"");
      out.print(request.getContextPath());
      out.write("/views/user/deleteUser?userId=\"+userId;\r\n");
      out.write("\t}\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function blackUser(userId,reason){\r\n");
      out.write("\tvar bool=confirm('경고횟수가 3회 이상인것을 확인 하셨습니까?');\r\n");
      out.write("\tif(bool){\r\n");
      out.write("\tlocation.href=\"");
      out.print(request.getContextPath());
      out.write("/admin/insertBlackList?userId=\"+userId+\"&reason=\"+reason;\r\n");
      out.write("\t}else{\r\n");
      out.write("\t\treturn;\r\n");
      out.write("\t}\r\n");
      out.write("}\r\n");
