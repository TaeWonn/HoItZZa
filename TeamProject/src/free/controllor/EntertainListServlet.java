...
/**
 * Servlet implementation class EntertainListServlet
 */
@WebServlet("/free/entertainList")
public class EntertainListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("======<entertainListServlet Start>======");
		int cPage = 1;
		int numPerPage = 10;
		...
		List<Free> enter = new FreeService().selectAllEnterList(cPage, numPerPage);
		
		int totalContents = new FreeService().selectEnterCount();
		System.out.println("리스트 " +enter+", 카운트 : "+totalContents);
