...
/**
 * Servlet implementation class NanumCommentServlet
 */
@WebServlet("/free/nanumComment")
public class NanumCommentServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new FreeService().insertNanumComment(c);
