...
/**
 * Servlet implementation class senceListServlet
 */
@WebServlet("/free/senseList")
public class SenceListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("======<SenseListServlet Start>======");
		int cPage = 1;
		int numPerPage = 10;
		...
		List<Free> sense = new FreeService().selectAllSenseList(cPage, numPerPage);
		
		int totalContents = new FreeService().selectSenseCount();
